...
public class GraphicsExample {
	...
	ToolBar_Old toolBar;				// toolbar that contains backItem and dbItem
...
void createToolBar(final Composite parent) {
	...
	ToolItem_Old  back = new ToolItem_Old(toolBar, SWT.PUSH);
	...
	ToolItem_Old  next = new ToolItem_Old(toolBar, SWT.PUSH);
	...
	backItem = new ToolItem_Old(toolBar, SWT.PUSH);
	...
	dbItem = new ToolItem_Old(toolBar, SWT.CHECK);
